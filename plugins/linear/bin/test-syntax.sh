...
#
# Usage:
#   /bin/bash packages/linear-development-harness/bin/test-syntax.sh   # test with macOS system bash 3.2
#   bash packages/linear-development-harness/bin/test-syntax.sh        # test with default bash
...
export CLAUDE_PROJECT_DIR="/tmp/linear-harness-test-$$"
...
run_test() {
  ...
  local err_file="/tmp/linear-harness-test-err-$$"
